/** @typedef {import('./html-tag').HtmlTagObject} HtmlTagObject */
/**
 * @file
 ...
 *
 * @param {HtmlTagObject} tagDefinition A tag element according to the htmlWebpackPlugin object notation
 * @param {boolean} xhtml Whether the generated html should add closing slashes to be xhtml compliant
 */
export function htmlTagObjectToString(tagDefinition, xhtml) {
 ...
 *  e.g. 'div'
 * @param {{[attributeName: string]: string|boolean|null|undefined }} [attributes] tag attributes
 *  e.g. `{ 'class': 'example', disabled: true }`
 * @param {string} [innerHTML]
 * @param {{[attributeName: string]: string|boolean|null|undefined}} [meta] meta information about the tag
 *  e.g. `{ 'plugin': 'HtmlEntryPlugin' }`
 * @returns {HtmlTagObject}
 */
export function createHtmlTagObject(tagName, attributes, innerHTML, meta) {
  return {
    tagName,
